	...
	<div class="reveal">
		<div class="slides">
				...
				<section>
					<div class="row">
						...
						<div class="col-6">
							...
							<div class="fragment">utilisons une fonctionalité
								<strong>déjà présente</strong> dans WordPress&nbsp;:
							</div>
			...
			<section>
				...
				<section><h1>WordPress nous permet d'associer des métadonnées à tous nos types de contenus.</h1>
				</section>
			...
			<section>
				...
				<section>
					<div class="table-layout">
						<div class="table-col-6 vertical-center">
							<h2>Demander à votre développeur de commencer à préparer le thème et les extensions?</h2>
						</div>
						<div class="table-col-6 vertical-center">
							<div class="fragment">
								<img class="full-width" src="img/grumpy-non.jpg" alt="" />
			...
			<section>
				<section>
					<h2>Champs ou taxonomies?</h2>

					<h3>( Les <em>Catégories</em> et les <em>Tags</em> sont des taxonomies )</h3>
				</section>
				<section><h2>Réponse&nbsp;:</h2>

					<h1 class="fragment">&laquo;&nbsp;Ça dépend.&nbsp;&raquo;</h1>
				</section>
			</section>
			...
			<section>
				...
				<section>
					<div class="table-layout">
						<div class="table-col-6"><h2>Maintenant, notre développeur nous aime.</h2></div>
						<div class="table-col-6"><img class="full-width" src="gifs/cat-typing-2.gif" alt="" /></div>
					</div>
				</section>
			</section>
			...
			<section>
				<section>
					...
					<h1 class="fragment"><a href="http://www.advancedcustomfields.com/">Advanced Custom Fields</a></h1>

					<div class="fragment">
						<h3>Aussi,...</h3>
						<ul>
							<li><a href="https://github.com/WebDevStudios/CMB2">Custom MetaBoxes 2 (CMB2)</a></li>
							<li><a href="http://pods.io/">Pods</a></li>
							<li><a href="https://wp-types.com/">Types + Views</a></li>
						</ul>
					</div>
				</section>
